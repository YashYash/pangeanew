...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Giver.charities'
        db.delete_column(u'giver_app_giver', 'charities_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Giver.charities'
        raise RuntimeError("Cannot reverse this migration. 'Giver.charities' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Giver.charities'
        db.add_column(u'giver_app_giver', 'charities',
    ...
    models = {
        ...
        u'giver_app.giver': {
            ...
            'charities': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['charity_app.Charity']", 'symmetrical': 'False'}),
