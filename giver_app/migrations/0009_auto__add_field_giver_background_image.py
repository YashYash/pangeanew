...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Giver.background_image'
        db.add_column(u'giver_app_giver', 'background_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Giver.background_image'
        db.delete_column(u'giver_app_giver', 'background_image')
