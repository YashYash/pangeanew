...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClickCount'
        db.create_table(u'charity_app_clickcount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fb_likes', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fb_shares', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fb_sends', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['charity_app.Video'])),
        ))
        db.send_create_signal(u'charity_app', ['ClickCount'])


    def backwards(self, orm):
        # Deleting model 'ClickCount'
        db.delete_table(u'charity_app_clickcount')
    ...
    models = {
        ...
        u'charity_app.clickcount': {
            ...
            'fb_likes': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'fb_sends': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'fb_shares': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
