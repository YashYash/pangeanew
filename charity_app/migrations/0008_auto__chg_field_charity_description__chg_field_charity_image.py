...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Charity.description'
        db.alter_column(u'charity_app_charity', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'Charity.image'
        db.alter_column(u'charity_app_charity', 'image', self.gf('django.db.models.fields.CharField')(max_length=2000))
