...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClickCount.facebook_count'
        db.add_column(u'charity_app_clickcount', 'facebook_count',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClickCount.facebook_count'
        db.delete_column(u'charity_app_clickcount', 'facebook_count')
