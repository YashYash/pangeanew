...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'charity_app_video', 'video_url', self.gf('django.db.models.fields.URLField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Video.video_url'
        db.alter_column(u'charity_app_video', 'video_url', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        ...
        u'charity_app.video': {
            ...
            'video_url': ('django.db.models.fields.URLField', [], {'max_length': '2000'})
        },
