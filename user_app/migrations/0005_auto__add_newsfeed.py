...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'user_app_newsfeed', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='newsfeed', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'user_app', ['Newsfeed'])


    def backwards(self, orm):
        # Deleting model 'Newsfeed'
        db.delete_table(u'user_app_newsfeed')
